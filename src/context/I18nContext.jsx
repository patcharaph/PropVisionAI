...
const MESSAGES = {
  ...
  th: {
    ...
    preview: {
      generateStaging: 'สร้างภาพตกแต่ง',
      remainingQuota: 'เหลือสิทธิ์สร้างภาพวันนี้ {{count}} ครั้ง',
      noGeneratedImage: 'ไม่พบภาพที่สร้างจากระบบ',
      quotaReached: 'คุณใช้สิทธิ์สร้างภาพครบแล้ววันนี้ กรุณากลับมาใหม่พรุ่งนี้',
      upgradePrompt: 'ต้องการสร้างภาพเพิ่มวันนี้ไหม? อัปเกรดเป็น Pro เพื่อรับสิทธิ์เพิ่ม',
      upgradePlan: 'อัปเกรดแพ็กเกจ',
      upgradeComingSoon: 'ระบบอัปเกรดกำลังจะเปิดให้ใช้งาน โปรดติดต่อผู้ดูแลระบบ',
    },
    loading: {
    ...
    result: {
      pageTitle: 'ผลลัพธ์การตกแต่งของคุณ',
      ...
      feedbackTitle: 'ให้คะแนนผลลัพธ์นี้',
      feedbackHint: 'ความคิดเห็นของคุณช่วยให้เราพัฒนาคุณภาพการตกแต่งได้ดียิ่งขึ้น',
      feedbackCommentPlaceholder: 'บอกเราว่าคุณชอบอะไร หรือควรปรับปรุงตรงไหน...',
      submitFeedback: 'ส่งความคิดเห็น',
      feedbackSubmitting: 'กำลังส่ง...',
      feedbackSuccess: 'ขอบคุณ! เราได้รับความคิดเห็นของคุณแล้ว',
      feedbackError: 'ไม่สามารถส่งความคิดเห็นได้ กรุณาลองใหม่อีกครั้ง',
      },
    roomTypes: {
